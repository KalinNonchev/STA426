...
```{r}
print(paste0("So finally, the mean and the variance from the samples is ", samples.mean, " and ", samples.var, ". When we log-transform the samples, we get a mean and variance of ", log.samples.mean, " and ", log.samples.var))
```